...
public class MovieDetails {
    ...
    private float date_uploaded_unix;
    ...
    public float getDate_uploaded_unix() {
        return date_uploaded_unix;
    }

    public void setDate_uploaded_unix(float date_uploaded_unix) {
    ...
    private class Torrent{
        ...
        public float getSize_bytes() {
            return size_bytes;
        }

        public void setSize_bytes(float size_bytes) {
